...
\begin{center}
  \large
  \sc{Worksheet: Basic exercises on Laplacians and Poisson equation}
  \normalsize
\end{center}
...
\epart{a} Prove that $f\in H^1(-\pi,\pi)$ via the original definition.

\vspace{30mm}

\epart{b} Prove that $f\in H^1(S^1)=H_{per}^1(-\pi,\pi)$ via the Fourier series (summability-of-coefficients) definition.
