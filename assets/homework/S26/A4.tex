...
\begin{document}
\scriptsize \noindent Math 617 Functional Analysis (Bueler) \hfill \emph{assigned 16 February 2026; {\color{red} version 3}}
\normalsize\medskip
...
\prob{P6}  \ppart{a} Consider a complex sequence $(a_n)_{n=1}^\infty$.  Show that if $a_n \to a \in \CC$ then the new sequence\footnote{The sum defining $b_n$ is corrected in this {\color{red} version 3}.}
