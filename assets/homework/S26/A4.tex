...
\bigskip
\noindent This Assignment is based on Chapters 2, 3, and 4 of our textbook,\footnote{K.~Saxe,~\emph{Beginning Functional Analysis}, Springer 2010.} and on the lectures.
...
\bigskip
\noindent \textsc{Do the following} Exercises from Chapter 3 (see pages x--x):

\bigskip
\noindent \textsc{Do the following} Exercises from Chapter 4 (see pages 88--91):

\begin{itemize}
\item \textbf{Exercise 4.x.x}
\end{itemize}
...
\prob{P5}  FIXME $\sum_{n=1}^\infty \frac{1}{n^2} = \frac{\pi^2}{6}$ using Parseval on $f(x)=x$ and its sine series
