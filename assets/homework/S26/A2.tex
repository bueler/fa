...
\begin{document}
\scriptsize \noindent Math 617 Functional Analysis (Bueler) \hfill \emph{assigned January 2026; {\color{BrickRed} version 5}}
\normalsize\medskip
...
\centerline{\textbf{Due Friday 6 February at the beginning of class} {\color{BrickRed} $\longleftarrow$ \emph{revised twice!}}}
\medskip
\normalsize
...
\bigskip
\noindent \textsc{Do the following} Exercises from Chapter 2 (see pages 29--31; {\color{BrickRed} 2.1.6 removed}):
...
\smallskip
\item \textbf{Exercise 2.3.8} {\color{BrickRed} (Extra Credit)}\strut \augment{You will use the fact that $\RR$ is complete.}
\end{itemize}
