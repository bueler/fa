...
\begin{document}
\scriptsize \noindent Math 617 Functional Analysis (Bueler) \hfill \emph{assigned January 2026; {\color{BrickRed} version 4}}
\normalsize\medskip
...
\centerline{\textbf{Due Wednesday 4 February at the beginning of class} {\color{BrickRed} $\longleftarrow$ \emph{revised}}}
\medskip
\normalsize
