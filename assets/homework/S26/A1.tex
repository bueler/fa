...
\begin{document}
\scriptsize \noindent Math 617 Functional Analysis (Bueler) \hfill \emph{assigned 12 January 2026; {\color{red} version 2}}
\normalsize\medskip
...
\centerline{\textbf{Due Friday 23 January} {\color{red} $\leftarrow$ \emph{revised}}}
\medskip
\normalsize
