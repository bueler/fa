...
\begin{quote}
\emph{Definition.}  Let $E\subset C([a,b])$.  The set $E$ is \emph{equicontinuous at} $x\in[a,b]$ if for any $\eps>0$ there exists a $\delta>0$ such that $y\in[a,b]$ and $|x-y|<\delta$ implies $|f(x)-f(y)|<\eps$ for all $f\in E$. FIXME
\end{quote}
