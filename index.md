---
layout: course-page
title: Bueler's Math F617 in Spring 2026 at UAF
---
...
I plan to teach this _functional analysis_ course as though it is in support of applied mathematics, and specifically the _finite element method_.  Each week I will start with an applied or numerical computation of some kind, and then spend the rest of the week gathering the functional analytic definitions and theory to support it.  Note that _infinite-dimensional normed vector spaces_, including _Hilbert_ and _Banach_ spaces, are central to functional analysis.  The exact solutions of continuum problems like partial differential equations live in such spaces.  Generally these are spaces of functions on domains in R^d, d=2,3, with some regularity to allow derivatives and boundary values; they are _Sobolev spaces_.  These spaces contain high-quality approximating finite-dimensional subspaces, specifically the piecewise-polynomial spaces of the finite element method.  This course is not primarily about finite element calculations themselves, and programming will **not** be an essential skill, but _linear functionals_, _integral operators_, _differential operators_, _bilinear forms_, _Sobolev spaces_, and _interpolation_ will be important ideas.
