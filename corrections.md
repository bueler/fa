...
**Page 50.**  Unfortunately, the statement of Lebesgue's Monotone Convergence Theorem, which is Theorem 3.13, is not correct.  To make the statement match the proof, one must add an assumption that the set of integrals $\{\int_A f_k\,dm\}$ is bounded.  Thus:
